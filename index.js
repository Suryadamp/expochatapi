...
const mongoURI = "mongodb+srv://sjsurya:Surya1234@cluster0.csm3e93.mongodb.net/Expochatapp?retryWrites=true&w=majority";
mongoose
  .connect(mongoURI, {
...
app.post("/friend-request", async(req,res)=> {
  ...
  console.log('req',currentUserId, selectedUserId)
try {
...
app.post("/friend-request/accept", async (req, res)=> {
  try {
    const {senderId, recepientId} = req.body
       ...
       sender.sentFriendRequests = recepient.sentFriendRequests.filter((request)=> request.toString() !== recepientId.toString())
